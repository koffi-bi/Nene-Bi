          ...
          <div class="logo-header" data-background-color="white">
            <a href="index.html" class="logo">
              <img
                ...
                alt="navbar brand" class="img-fluid" style="max-width: 150px;"
                class="navbar-brand"
                height="20"
              />
            </a>
      ...
      <div class="main-panel">
          ...
          <div class="page-inner"style="position:relative; left:15%; ">
            ...
            <div class="row mt-4" >
              <div class="col-sm-6 col-md-3">
                <div class="card card-stats card-round" style="border-radius: 30%; background-color:#f10cf3; " >
                  <div class="card-body">
                    <div class="col-icon"style="position: relative; left: 45%; transform: translateX(-50%); ">
                      <div
                        class="icon-big text-center icon-primary bubble-shadow-small" style=" background-color:#f10cf3;"
                      >
                    ...
                    <div class="row align-items-center" style="position: relative; right: 15%; transform: translateX(50%);">
                      <div class="col col-stats ms-3 ms-sm-0 mb-6" style="width: 100px; height: 130px; ">
                        <div class="numbers">
                          <p class="card-category" style="color:#ffffff; font-weight:bold;">Dépôt</p>
                          <h4 class="card-title" style="color:#ffffff; font-weight:bold;">0</h4>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-sm-6 col-md-3" >
                <div class="card card-stats card-round"style="border-radius: 30%; left:50%; background-color:#8022f4;">
                  <div class="card-body">
                    <div class="col-icon" style="position: relative; left: 45%; transform: translateX(-50%);">
                      <div
                        class="icon-big text-center icon-info bubble-shadow-small" style=" background-color:#8022f4;"
                      >
                    ...
                    <div class="row align-items-center"style="position: relative; right: 15%; transform: translateX(50%);">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0"style="width: 100px; height:130px; "  >
                        <div class="numbers " >
                          <p class="card-category" style="color:#ffffff; font-weight:bold;">Retrait</p>
                          <h4 class="card-title" style="color:#ffffff; font-weight:bold;">0</h4>
                        </div>
                      </div>
                    </div>
       ...
       <section class="chart">
        ...
        <ul class="chart-legend">
            <li><span class="color en-cours"></span> En cours</li>
            <li><span class="color arriver"></span> Arrivé</li>
            <li><span class="color disponible"></span> Disponible</li>
        </ul>
    </section>
</main>
</div>
